...
def createDelexData():
    ...
    fin1 = file('data/multi-woz/data.json', encoding='utf-8')
    
    data = json.load(fin1)

    fin2 = file('data/multi-woz/dialogue_acts.json', encoding='utf-8')
    ...
    with open('data/multi-woz/delex.json', 'w', encoding='utf-8') as outfile:
        json.dump(delex_data, outfile, indent=2, ensure_ascii=False)
    return delex_data
...
def divideData(data):
    ...
    data_no_delex = json.load(open('data/multi-woz/data.json', encoding='utf-8'))
    testListFile = []
    fin = file('data/multi-woz/testListFile.json', encoding='utf-8')
    for line in fin:
        testListFile.append(line[:-1])
    fin.close()

    valListFile = []
    fin = file('data/multi-woz/valListFile.json', encoding='utf-8')
    for line in fin:
        valListFile.append(line[:-1])
    fin.close()

    trainListFile = file('data/multi-woz/trainListFile.json','w', encoding='utf-8')
    dialogue_acts = json.load(open('data/multi-woz/dialogue_acts.json', encoding='utf-8'))
    ...
    with open('data/valid.json', 'w', encoding='utf-8') as f:
        json.dump(val_dials, f, indent=4, ensure_ascii=False)

    with open('data/test.json', 'w', encoding='utf-8') as f:
        json.dump(test_dials, f, indent=4, ensure_ascii=False)

    with open('data/train.json', 'w', encoding='utf-8') as f:
        json.dump(train_dials, f, indent=4, ensure_ascii=False)
...
def buildDictionaries(word_freqs_usr, word_freqs_sys):
    ...
    with open('data/input_lang.index2word.json', 'wb', encoding='utf-8') as f:
        json.dump(idx2words[0], f, indent=2, ensure_ascii=False)
    with open('data/input_lang.word2index.json', 'wb', encoding='utf-8') as f:
        json.dump(dicts[0], f,indent=2, ensure_ascii=False)
    with open('data/output_lang.index2word.json', 'wb', encoding='utf-8') as f:
        json.dump(idx2words[1], f,indent=2, ensure_ascii=False)
    with open('data/output_lang.word2index.json', 'wb', encoding='utf-8') as f:
        json.dump(dicts[1], f,indent=2, ensure_ascii=False)
