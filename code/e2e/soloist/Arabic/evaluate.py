...
class MultiWozEvaluator(BaseEvaluator):
    def __init__(self, data_name):
        ...
        self.delex_dialogues = json.load(file('data/multi-woz/delex.json', encoding="utf-8"))
            ...
            for domain in goal.keys():
                ...
                if '[' + domain + '_name]' in sent_t or '_id' in sent_t:
                    if domain in ['restaurant', 'hotel', 'attraction', 'train']:
                        ...
                        venues = self.db.queryResultVenues(domain, realDialogue['log'][t * 2 + 1], state,
                                                           real_belief=False)
...
if __name__ == '__main__':
    ...
    # f = '../../../output/en_large_ep5_sd3_uft8.json'
    f = args.eval_file
    # f = '../../../data/Arabic/rp/test.soloist.json'
    print(f)
