...
valid_data = json.load(open('data/valid.json', encoding="utf-8"))
...
def write_data_for_internal_v1(data, output_file, output_idx_file):
    ...
    json.dump(flist, open(output_idx_file,'w',encoding='utf-8'),ensure_ascii=False)
    json.dump(examples, open(output_file,'w',encoding='utf-8'),indent=2,ensure_ascii=False)
    print(len(examples))
