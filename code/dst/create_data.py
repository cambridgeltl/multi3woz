...
def divideData(data,args):
    ...
    # save all dialogues
    with open(os.path.join(args.target_path, 'dev_dials.json'), 'w', encoding='utf8') as f:
        json.dump(val_dials, f, indent=4, ensure_ascii=False)

    with open(os.path.join(args.target_path, 'test_dials.json'), 'w', encoding='utf8') as f:
        json.dump(test_dials, f, indent=4, ensure_ascii=False)

    with open(os.path.join(args.target_path, 'train_dials.json'), 'w', encoding='utf8') as f:
        json.dump(train_dials, f, indent=4, ensure_ascii=False)

    with open(os.path.join(args.target_path, 'ontology.json'), 'w', encoding='utf8') as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mwz_ver", type=str, default='2.3')
    parser.add_argument("--target_path", type=str, default='data/mwz2.3')
