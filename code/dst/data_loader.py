...
def prepare_data(args, tokenizer):
    path_train = args['data_dir'] + '/train_dials.json'
    path_dev = args['data_dir'] + '/dev_dials.json'
    path_test = args['data_dir'] + '/test_dials.json'
    ...
    # data_train = data_train[:split_n]
    # print('after splitting, the length of the train set', len(data_train))
